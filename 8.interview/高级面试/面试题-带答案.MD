...
2.FIS如何实现资源定位和模块化(解释下resource-map以及mod原理）

3.Webpack作用，webpack模块化与Browerify区别，工程中Webpack与Gulp如何分工

4.Gulp与Grunt的区别，流原理，切分文件
...
8.快速排序时间复杂度,如何判断算法的时间复杂度是多少

##8.MVC框架

1.Angular出现解决了什么问题，适用场景有哪些？

2.Angular如何渲染，优点，依赖注入，为什么要实现依赖注入，好处是什么。双向数据绑定和单向数据绑定区别是什么？Angular工程化，Angular工程的目录结构，Augular2做了哪些改动

3.React 出现解决了什么问题，适用场景有哪些？

4.React组件交互，React如何实现数据双向绑定，jsx的优点，有了解过dom diff算法么，生命周期

5.React-native使用的过程中遇到了哪些问题？如何解决？

6.React与Angular渲染方式的区别是什么？如何性能优化？
